  ...
  return (
    ...
    >
      <Link
        ...
        className="group relative flex h-full flex-col justify-between overflow-hidden rounded-3xl border border-border bg-card/20 p-8 transition-colors duration-300 hover:border-border-strong hover:bg-card/50 hover:shadow-xl hover:shadow-black/30"
      >
        ...
        <div className="relative">
          <div className={`mb-4 text-xs font-medium ${textColor[project.type]}`}>{typeLabel[project.type]}</div>
